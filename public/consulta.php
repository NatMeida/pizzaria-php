...
<body>
    ...
    <main>
        <form action="./consulta.php" class="container" hx-get="./components/table_consulta.php"
            ...
            <div class="grid" style="margin-bottom: var(--spacing); ">
                <button type="reset" href="consulta.php" class="secondary" hx-get="./components/table_consulta.php"
        ...
        <form>
            <?php require_once __DIR__ . "/components/table_consulta.php"; ?>
